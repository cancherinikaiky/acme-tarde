		...
		<div class="row">
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="<?= url("assets/web/"); ?>images/speakers/speaker-one.jpg" alt="speaker" class="img-fluid">
			...
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="<?= url("assets/web/"); ?>images/speakers/speaker-two.jpg" alt="speaker" class="img-fluid">
						<div class="primary-overlay"></div>
						<div class="socials">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="<?= url("assets/web/"); ?>images/speakers/speaker-three.jpg" alt="speaker" class="img-fluid">
						<div class="primary-overlay"></div>
						<div class="socials">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="<?= url("assets/web/"); ?>images/speakers/speaker-four.jpg" alt="speaker" class="img-fluid">
						<div class="primary-overlay"></div>
						<div class="socials">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="<?= url("assets/web/"); ?>images/speakers/speaker-five.jpg" alt="speaker" class="img-fluid">
						<div class="primary-overlay"></div>
						<div class="socials">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="<?= url("assets/web/"); ?>images/speakers/speaker-six.jpg" alt="speaker" class="img-fluid">
						<div class="primary-overlay"></div>
						<div class="socials">
							<ul class="list-inline">
								<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
			...
			<div class="col-lg-4 col-md-6">
				...
				<div class="testimonial-item">
					...
					<div class="person">
						<div class="media">
							<!-- Person Image -->
							<img src="<?= url("assets/web/"); ?>images/speakers/speaker-thumb-three.jpg" alt="person-image">
			...
			<div class="col-lg-4 col-md-6">
				...
				<div class="testimonial-item">
					...
					<div class="person">
						<div class="media">
							<!-- Person Image -->
							<img src="<?= url("assets/web/"); ?>images/speakers/speaker-thumb-one.jpg" alt="person-image">
							<div class="media-body">
								<!-- Person Name -->
			...
			<div class="col-lg-4 col-md-6 mx-auto">
				...
				<div class="testimonial-item">
					...
					<div class="person">
						<div class="media">
							<!-- Person Image -->
							<img src="<?= url("assets/web/"); ?>images/speakers/speaker-thumb-five.jpg" alt="person-image">
							<div class="media-body">
								<!-- Person Name -->
